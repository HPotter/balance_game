package com.sutorei.balance.view;
...
import com.sutorei.balance.domain.BalanceData;
import com.sutorei.balance.domain.BalanceViewObject;
import com.sutorei.balance.domain.WeightedObject;
import com.sutorei.balance.util.BalanceBitmapContainer;
import com.sutorei.balance.domain.BalanceState;
...
public class BalanceView extends View {
	...
	public BalanceView(Context context, File balanceResourceFolder,
			BalanceData balanceData, int taskId) {
		super(context);
		taskLoaded = false;
		try {
